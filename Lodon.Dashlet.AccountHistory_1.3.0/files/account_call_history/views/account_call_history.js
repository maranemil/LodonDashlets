({
    ...
    initDashlet: function (view) {
        ...
        this.viewName = view;
        const settings = _.extend({}, this._defaultOptions, this.settings.attributes);
    ...
    loadData: function (options) {
        ...
        let self = this;
        let url = app.api.buildURL('Accounts', this.model.get("id"));
        ...
        app.api.call('READ', url, {}, {
            success: function (data) {
                ...
                self.all_call_history.sort(function (a, b) {
                    const date_a = a.date_start;
                    const date_b = b.date_start;
                    if (date_a < date_b)
                        return 1
                    if (date_a > date_b)
                        return -1
